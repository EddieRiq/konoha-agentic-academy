...
class VersionContractTests(unittest.TestCase):
    ...
    def test_repository_contract_passes(self):
        # v4.1.1 release closure: product/candidate version and the last
        # public/installable release tag now intentionally converge on
        # v4.1.1. See test_candidate_version_ahead_of_installable_tag_is_accepted
        ...
        self.assertEqual(report["values"]["package_version"],"4.1.1")
        self.assertEqual(report["values"]["runtime_version"],"4.1.1")
        self.assertEqual(report["values"]["runtime_tag"],"v4.1.1")
        self.assertEqual(report["values"]["installer_tag"],"v4.1.1")
    ...
    def test_konoha_v4_cli_version_matches_current_release(self):
        ...
        self.assertEqual(completed.stdout.strip(), "4.1.1")
